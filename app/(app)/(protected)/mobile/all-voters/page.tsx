...
export default function FilteredVoterListPage() {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen bg-gray-50 flex flex-col pb-24 md:max-w-md md:mx-auto md:border-x border-gray-200 mt-16">
        {/* --- Sticky Header --- */}
        <div className="bg-white px-4 pt-6 pb-4 shadow-sm sticky top-16 z-10 border-b border-gray-100 flex flex-col gap-4">
